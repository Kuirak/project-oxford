...
describe('Project Oxford Face API Test', function () {
    ...
    describe('#similar()', function () {
        it('detects similar faces', function (done) {
            ...
            Promise.all(detects).then(function () {
...
describe('Project Oxford Vision API Test', function () {
    ...
    it('analyzes a local image from a stream', function (done) {
        this.timeout(30000);
        client.vision.analyzeImage({
            stream: fs.createReadStream('./test/images/vision.jpg'),
            ImageType: true,
            Color: true,
            Faces: true,
            Adult: true,
    ...
    it('creates a thumbnail for a local image from a stream', function (done) {
        this.timeout(30000);
        client.vision.thumbnail({
            stream: fs.createReadStream('./test/images/vision.jpg'),
    ...
    it('runs OCR on a local image from a stream', function (done) {
        this.timeout(30000);
        client.vision.ocr({
            stream: fs.createReadStream('./test/images/vision.jpg'),
            language: 'en',
